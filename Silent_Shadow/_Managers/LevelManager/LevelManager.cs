...
namespace Silent_Shadow.Managers
{
	...
	public class LevelManager : ILevelManager
	{
		...
		private Texture2D LoadTilesetTexture(string tilesetName)
		{
		...
		$"TileSheets/MansionTileSets/{tilesetName}"
			...
			throw new Exception($"Tileset '{tilesetName}' konnte in den angegebenen Ordnern nicht gefunden werden.");
		}
		...
		public Level LoadLevel(string level)
		{
			...
			{
				//Um mehere Tilesets zu finden die im unterordner liegen
